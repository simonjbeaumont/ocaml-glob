...
(* OASIS_START *)
(* DO NOT EDIT (digest: 12de395d7e784321d5db5620fd66e244) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_glob", []))];
     ...
     package =
       {
          ...
          authors = ["Si Beaumont"];
          homepage = Some "https://github.com/simonjbeaumont/ocaml-glob";
          synopsis =
            "Pure OCaml implementation of some glob-based library functions";
          description = None;
          categories = [];
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_glob.ml"});
               Test
                 ({
                     cs_name = "test_pci_db";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\196\252\164\022\251:?\188rM\165\254\222\177V\206";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
